...
const UserAvatar = () => (
  <div className={styles.userAvatar}>
    <div className={styles.avatarBorder}>
      <img
        src="https://images.unsplash.com/vector-1738312097380-45562da00459?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=880"
        alt="User"
      />
    </div>
  </div>
...
const BotAvatar = ({ isTyping }) => (
  <div className={`${styles.botAvatar} ${isTyping ? styles.typing : ""}`}>
    <div className={styles.avatarBorder}>
      <img src="/logo.png" alt="BrightBuddy" />
    </div>
  </div>
);
