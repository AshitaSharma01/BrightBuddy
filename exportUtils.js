...
export function exportAsText(messages, sessionTitle = "BrightBuddy Chat") {
  try {
    ...
    messages.forEach((message, index) => {
      const role = message.role === 'user' ? 'You' : 
                   message.role === 'assistant' ? 'BrightBuddy' : 'System';
...
export function exportAsPDF(messages, sessionTitle = "BrightBuddy Chat") {
  try {
